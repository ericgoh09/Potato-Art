<%@ Page Language="C#" MasterPageFile="~/LoginMaster.Master" AutoEventWireup="true" CodeBehind="SignupArtist.aspx.cs" Inherits="part1.SignupArtist" %>

<asp:Content ID="ContentSignupArtist" ContentPlaceHolderID="ContentPlaceHolderLogin" runat="server">
    ...
    <style type="text/css">
        ...
        <div>
            ...
            <table class="auto-style4" border="0" style="background-color: #C0C0C0">
                ...
                <tr>
                    <th colspan="4">
                        <u><asp:Label ID="loginTitle" runat="server" Text="Artist Details"></asp:Label></u>
                    </th>
                </tr>
                ...
                <tr>
                    ...
                    <asp:Label ID="Label4" runat="server" Text="Artist Name: "></asp:Label>
                        ...
                        <asp:TextBox ID="txtArtistName" runat="server" Width="95%"></asp:TextBox>
                    </td><td class="auto-style5">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtArtistName" ErrorMessage="Artist name is required." ForeColor="Red">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="auto-style5"></td><td class="auto-style7">
                        ...
                        <asp:RadioButtonList ID="rblArtistGender" runat="server">
                            <asp:ListItem>Male</asp:ListItem>
                            <asp:ListItem>Female</asp:ListItem>
                        </asp:RadioButtonList>
                    </td><td class="auto-style5">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="rblArtistGender" ErrorMessage="Gender is required." ForeColor="Red">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="auto-style2"></td><td class="auto-style8">
                        ...
                        <asp:Label ID="Label3" runat="server" Text="(+60)"></asp:Label><asp:TextBox ID="txtArtistPhone" runat="server" Width="80%"></asp:TextBox>
                ...
                <tr>
                    <td class="auto-style3"></td><td class="auto-style9">
