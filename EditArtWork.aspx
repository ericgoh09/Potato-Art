<%@ Page Language="C#" MasterPageFile="~/Seller.Master" AutoEventWireup="true" CodeBehind="EditArtWork.aspx.cs" Inherits="Assignment.EditArtWork" %>
        ...
        <div>
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtArtName" runat="server" CssClass="textfieldStyle" AutoPostBack="true"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPrice" runat="server" CssClass="textfieldStyle"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:ValidationSummary CssClass="validationSummary" ID="ValidationSummary1" runat="server" ForeColor="Red"/>
                    </td>
                </tr>
            </table>
        </div>
